...
if useNetworkx :
    try :
        ...
        print "Library 'networkx' not present"
        networkxLoad = False
    
if networkxLoad :
    print "Trees module will use networkx library"
else :
    print "Trees module will use pure python implementation"
...
print ("-----------------------------")
print "FrozenTree:", dir(FrozenTree)
print "Tree:", dir(Tree)
print "IndexedFrozenTree:", dir(IndexedFrozenTree)
print "IndexedTree:", dir(IndexedTree)
tree = Tree ('a', ('aa', 'ab'), 'b', ('ba', 'bb'), 'c', ('ca', 'cb'))
print dir(tree)
...
#import pickle
#picklestring = pickle.dumps(iTree)
#print picklestring

#iTree = IndexedTree.__new__(IndexedTree, 'a', ('aa', 'ab'), 'b', ('ba', 'bb'), 'c', ('ca', 'cb'))
#print dir(iTree)
#print iTree.formatted()
...
if 'ba' in tree :
    print "'ba' is in Tree %s" % tree
if 'ba' in iTree :
    print "'ba' is in IndexedTree %s" % iTree
#
sTree = Tree ('top', ('a', ('aa', 'ab'), 'b', ('ba', 'bb'), 'c', ('ca', 'cb')))
print iTree
print sTree
print tuple(iTree)
print tuple(sTree)
print [k for k in iTree]
print [k for k in sTree]
print [k.value for k in iTree.preorder()]
print [k.value for k in iTree.postorder()]
print [k.value for k in iTree.breadth()]
print [k.value for k in sTree.preorder()]
print [k.value for k in sTree.postorder()]
print [k.value for k in sTree.breadth()]
print "-----------------" 


print list(iTree.path())
print list(iTree['ba'].parents())
print list(iTree['ba'].path())
print list(iTree.path('ba'))
#
