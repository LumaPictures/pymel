...
import pmcmds
import maya.cmds
from pymel.util.testingutils import TestCaseExtended
...
# If this is true, then we will run tests to make sure that maya commands FAIL when we expect them to...
...
TestWrappedCmds.addTestsForCmd('group', 'transform', mayaFailsOnCustomLists=True, canTakeListArg=True, extraKwArgs={'absolute':1})
TestWrappedCmds.addTestsForCmd('select', 'transform', mayaFailsOnCustomLists=True, canTakeListArg=True)
...
TestWrappedCmds.addTestsForCmd('listAttr', 'transform', mayaFailsOnCustomStrings=False, mayaFailsOnCustomLists=True, canTakeListArg=True)
...
TestWrappedCmds.addTestsForCmd('listRelatives', 'transform', mayaFailsOnCustomLists=True, canTakeListArg=True)
...
mayaCmdsSuite.addTests( (mayaCmdsSuite_shouldPass, mayaCmdsSuite_shouldFail) )
