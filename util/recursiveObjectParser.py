...
#        else:
        rulesDict, tokensDict = Parser.getRulesAndTokens( inspect.getmembers(parsercls) )
                
        tokens = tuple(tokensDict.keys())
...
#                        _printClassTree( base )
                ...
                if token is not None:
                    ...
                    parserdict['tokensDict'] = {tokenName:token}
