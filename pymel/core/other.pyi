...
class NameParser(str):
    ...
    def stripNamespace(self, levels: int = ...) -> Self: ...
    def stripGivenNamespace(self, namespace: str, partial: bool = ...) -> Self: ...
    def swapNamespace(self, prefix: str) -> Self: ...
    def namespaceList(self) -> List[str]: ...
    def namespace(self) -> str: ...
    def addPrefix(self, prefix: str) -> Self: ...
...
class DependNodeName(NameParser):
    def node(self) -> Self: ...
    def nodeName(self) -> Self: ...
    def exists(self, **kwargs): ...
    def stripNum(self) -> str: ...
    def extractNum(self) -> str: ...
    def nextUniqueName(self) -> Self: ...
    def nextName(self) -> Self: ...
    def prevName(self) -> Self: ...
