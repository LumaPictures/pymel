...
class Mesh(SurfaceShape):
    ...
    def booleanOps(self, op: Mesh.BoolOperation, meshes: List[Union[str, DependNode]]) -> bool: ...
...
class Assembly(DagContainer):
    ...
    def createRepresentation(self, val: Union[_util.ProxyUnicode, str] = ..., **kwargs: Any) -> None: ...
