...
class Vector(list):
    ...
    def rotateBy(v, axis, theta):
       """
       Rotate Vector v around Vector axis by angle theta
       ...
       rotationMatrix = Matrix([
           [t*pow(axis.x, 2) + c, t * axis.x * axis.y - s * axis.z, t * axis.x * axis.z + s * axis.y,   0], 
           [t *axis.x * axis.y + s * axis.z,   t*pow(axis.y,2) + c, t * axis.y * axis.z - s * axis.x,   0],
           [t * axis.x * axis.z - s*axis.y,   t * axis.y * axis.z + s * axis.x,   t * pow(axis.z,2) + c,  0],
           [0,0,0,1]])
